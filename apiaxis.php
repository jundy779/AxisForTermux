...
class #
{
    function cPOST_#($#)
    {
        ...
        curl_setopt($ch, CURLOPT_URL,sprintf($crypto->decrypt($url_encrypt),$#));
        curl_setopt($ch, CURLOPT_POST, 1);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt ($ch, CURLOPT_ENCODING, "gzip");
        $server_output = curl_exec ($ch);
    ...
    {
        $status_a = explode('{"status_user":',$this->cPOST_#($data));
    ...
    {
        $name_a = explode('"user":"',$this->cPOST_#($data));
    ...
    {
        $expire_a = explode('"expire_user":"',$this->cPOST_#($data));
...
class ApiAXIS
{
    ...
    function Result_BuyPackage_v2($status_user,$name_user,$expire_user,$#,$token,$pkgid_buy_v2)
    {
        $Red      = "\e[0;31m";
        $Green  = "\e[0;32m"; 
    ...
    function Result_BuyPackage_v3($status_user,$name_user,$expire_user,$#,$token,$pkgid_buy_v2)
    {
        $Red      = "\e[0;31m";
        $Green  = "\e[0;32m"; 
    ...
    function DoublePacket_BuyPackage($status_user,$name_user,$expire_user,$#,$token,$pkgid)
    {
        $this->Result_BuyPackage_v2($status_user,$name_user,$expire_user,$#,$token,$pkgid);
        $this->Result_BuyPackage_v3($status_user,$name_user,$expire_user,$#,$token,$pkgid);
    }

    function Claimmccm($#,$token,$pkgid_claimmccm)
    {
        $crypto = new ApiCrypto;
    ...
    function Result_Claimmccm($status_user,$name_user,$expire_user,$#,$token,$pkgid_claimmccm)
    {
        $Red      = "\e[0;31m";
        $Green  = "\e[0;32m"; 
        $result_claimmccm = $this->Claimmccm($#,$token,$pkgid_claimmccm);
    ...
    function Claimmccm_v2($#,$token,$pkgid_claimmccm_v2)
    {
        $crypto = new ApiCrypto;
    ...
    function Result_Claimmccm_v2($status_user,$name_user,$expire_user,$#,$token,$pkgid_claimmccm_v2)
    {
        $Red      = "\e[0;31m";
        $Green  = "\e[0;32m"; 
        $result_claimmccm_v2 = $this->Claimmccm_v2($#,$token,$pkgid_claimmccm_v2);
    ...
    function DoublePacket_Claimmcm($status_user,$name_user,$expire_user,$#,$token,$pkgid)
    {
        $this->Result_Claimmccm($status_user,$name_user,$expire_user,$#,$token,$pkgid);
        $this->Result_Claimmccm_v2($status_user,$name_user,$expire_user,$#,$token,$pkgid);
    }
}
...
$# = trim(fgets(STDIN));
$GLOBALS["#"] = $#;
$status_user = $c#->get_status_user($GLOBALS["#"]);
$GLOBALS["status_user"] = $status_user;
if($GLOBALS["status_user"] == "200")
{
    $GLOBALS["name_user"] = $c#->get_name_user($GLOBALS["#"]);
    $GLOBALS["expire_user"] = $c#->get_expire_user($GLOBALS["#"]);
    echo "\n";
...
$result_otp = $axis->SendOTP($GLOBALS["#"],$nomor);
...
$result_login = $axis->LoginOTP($GLOBALS["#"],$nomor, $otp);
...
function getBuyPackage()
{
    ...
    switch($choise){
        case '1' :
            $buy = $axis->DoublePacket_BuyPackage($GLOBALS["status_user"] ,$GLOBALS["name_user"],$GLOBALS["expire_user"],$GLOBALS["#"],$GLOBALS["token"],$crypto->decrypt("-QERCE2V7OsHsaF4ukoLlw=="));
            break;

        case '2' :
            $buy = $axis->DoublePacket_BuyPackage($GLOBALS["status_user"] ,$GLOBALS["name_user"],$GLOBALS["expire_user"],$GLOBALS["#"],$GLOBALS["token"],$crypto->decrypt("_HWiDPCSEaMHsaF4ukoLlw=="));
            break;

        case '3' :
            $buy = $axis->DoublePacket_BuyPackage($GLOBALS["status_user"] ,$GLOBALS["name_user"],$GLOBALS["expire_user"],$GLOBALS["#"],$GLOBALS["token"],$crypto->decrypt("Syma9QW6JwAHsaF4ukoLlw=="));
            break;

        case '4' :
            $buy = $axis->DoublePacket_BuyPackage($GLOBALS["status_user"] ,$GLOBALS["name_user"],$GLOBALS["expire_user"],$GLOBALS["#"],$GLOBALS["token"],$crypto->decrypt("ALEamI8eFzwHsaF4ukoLlw=="));
            break;

        case '5' :
            $buy = $axis->DoublePacket_BuyPackage($GLOBALS["status_user"] ,$GLOBALS["name_user"],$GLOBALS["expire_user"],$GLOBALS["#"],$GLOBALS["token"],$crypto->decrypt("r4r4DFlay5UHsaF4ukoLlw=="));
            break;

        case '6' :
            $buy = $axis->DoublePacket_Claimmcm($GLOBALS["status_user"] ,$GLOBALS["name_user"],$GLOBALS["expire_user"],$GLOBALS["#"],$GLOBALS["token"],$crypto->decrypt("tHSCk3quBA8HsaF4ukoLlw=="));
            break;
    
        case '7' :
            $buy = $axis->DoublePacket_Claimmcm($GLOBALS["status_user"] ,$GLOBALS["name_user"],$GLOBALS["expire_user"],$GLOBALS["expire_user"],$GLOBALS["#"],$GLOBALS["token"],$crypto->decrypt("kzdvhAkuWKgHsaF4ukoLlw=="));
            break;
    
        case '8' :
            $buy = $axis->DoublePacket_Claimmcm($GLOBALS["status_user"] ,$GLOBALS["name_user"],$GLOBALS["expire_user"],$GLOBALS["#"],$GLOBALS["token"],$crypto->decrypt("LqMMzM3jDO0HsaF4ukoLlw=="));
            break;
    
        case '9' :
            $buy = $axis->DoublePacket_Claimmcm($GLOBALS["status_user"] ,$GLOBALS["name_user"],$GLOBALS["expire_user"],$GLOBALS["#"],$GLOBALS["token"],$crypto->decrypt("nqqpE2OxQ04HsaF4ukoLlw=="));
            break;
    
        case '10' :
            $buy = $axis->DoublePacket_Claimmcm($GLOBALS["status_user"] ,$GLOBALS["name_user"],$GLOBALS["expire_user"],$GLOBALS["#"],$GLOBALS["token"],$crypto->decrypt("rugMpL3Py2AHsaF4ukoLlw=="));
            break;

        case '11' :
            $buy = $axis->DoublePacket_BuyPackage($GLOBALS["status_user"] ,$GLOBALS["name_user"],$GLOBALS["expire_user"],$GLOBALS["#"],$GLOBALS["token"],$crypto->decrypt("-EinJZs3PlIHsaF4ukoLlw=="));
            break;
...
echo "\n";
    ...
    echo "\n";
    echo "$Red ".$c#->get_name_user($GLOBALS["#"]). "\n";
    echo "\n";
    goto repeat_#;
}
?>
